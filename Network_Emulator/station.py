                        ...
                        if content == "arp":
                            ...
                            for pending in pending_queue:
                                print("Pending IP Packet - Destination IP: {}, Source IP: {}, Protocol Type: {}, Data Length: {}, Data: {}".format(
                                    pending.pending_pkt.dstip,
                                    pending.pending_pkt.srcip,
                                    pending.pending_pkt.prot_type,
                                    pending.pending_pkt.data_length,
                                    repr(pending.pending_pkt.data)
                                ))
                        elif content == "host":
